...
new_list_gen = ((tutor, klass) for tutor, klass in zip(tutors, klasses))
print(*new_list_gen)

from itertools import zip_longest

new_list_gen = ((tutor, klass) for tutor, klass in zip_longest(tutors, klasses) if tutor is not None)
print(next(new_list_gen))